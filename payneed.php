...
while($check = mysqli_fetch_array($rt)){
      ...
      $value=mysqli_fetch_assoc(mysqli_query($conn,"select * from clientneed where id='$niddmo'"));
        $jobtype3[$i]=$value['jobtype'];
 $i++;
 }
								...
								<table class="table table-striped custom-table datatable">
									...
									<?php
                                        ...
                                        <tr>
											...
											<td>'.$period3[$j].'</td>
											<td>'.$salary3[$j].'</td>
											<td><a class="btn btn-primary" href="payment.php?jid='.$id3[$j].'&cid='.$cid.'">All Payment</a></td>
										</tr>
