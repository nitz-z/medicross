                                        ...
                                        while($num2>0)
                                        {
											...
											<td>
												<h2 class="table-avatar">
													<a href="javascript:void(0)" class="avatar view_data" id="'.$id2[$j].'" ><img src="image/'.$photo2[$j].'" alt=""></a>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($num3>0)
                                        {
											...
											<td>
												<h2 class="table-avatar">
													<a href="javascript:void(0)" class="avatar view_data" id="'.$id3[$j].'"><img src="image/'.$photo3[$j].'" alt=""></a>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="jobcardreassign.php" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control datetimepicker" type="text" name="nstartdate">
                                                    <label>New Period<span class="text-danger">*</span></label>
                                                    <input class="form-control" type="number" name="nperiod">
                                                    <label>Registration Fee<span class="text-danger">*</span></label>
                                                    <input class="form-control" type="number" name="nregfee">
                                                      <label>Registration Period<span class="text-danger">*</span></label>
                                                    <input class="form-control" type="number" name="nregper">
