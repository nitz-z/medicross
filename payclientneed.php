...
$regid[$i]=$check['regid'];
 ...
 $i++;
        ...
        $sql = "select * from clientneed where cid='$cid' and status in (0,3) order by id desc";
$i=0;
$rt= mysqli_query($conn,$sql);
								...
								<table class="table table-striped custom-table datatable">
									...
									<?php
                                        ...
                                        <tr>
											...
											<td>'.$period3[$j].'</td>
											<td>'.$salary3[$j].'</td>
											<td><a class="btn btn-primary" href="paymentneed.php?nid='.$id3[$j].'&cid='.$cid.'&sts=0">All Payment</a></td>
										</tr>
								...
								<table class="table table-striped custom-table datatable">
									...
									<?php
                                        ...
                                        <tr>
											...
											<td>'.$period3[$j].'</td>
											<td>'.$salary3[$j].'</td>
											<td><a class="btn btn-primary" href="paymentneed.php?nid='.$id3[$j].'&cid='.$cid.'&sts=1">All Payment</a></td>
										</tr>
