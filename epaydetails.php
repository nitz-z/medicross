...
$regid4[$i]=$check['regid'];
 ...
 $i++;
        ...
        $sql = "select * from epayment where eid='$eid' and jid='$jid' order by id desc";
$i=0;
             	  $total=0;
$rt= mysqli_query($conn,$sql);
...
//echo "% 28".$d2;
 ...
 $sql = "insert into epayment(eid,jid,nid,day,amount) 
     values('$eid','$jid','$nid','$day','$amount')";
 ...
 $flo2="";
        ...
        $flo2[7]="-";
            ...
            $flo2[8]=$flo[0];
            $flo2[5]=$flo[3];
                    $sql3="insert into loss (amount,date,exid,tab,note) values('$amount','$flo2','$dmoid','epayment','Employe Salary')";
											...
											<div class="row">
												<div class="col-md-12 ">
													<div class="profile-info-left">
														<h3 class="user-name m-t-0 mb-0"><?php echo $fname4[0]." ".$lname4[0];?></h3>&nbsp;
											
														<div class="staff-id">Client ID :<?php echo $regid4[0];?> </div>&nbsp;
														<div class="text">Phone : <?php echo $phno4[0];?></div>&nbsp;
													</div>
												</div>
											...
											<div class="row">
												<div class="col-md-12">
													<div class="profile-info-left">
														...
														<div class="staff-id">Employee ID :<?php echo $regid[0];?> </div>&nbsp;
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="epaydetails.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-xl-6">
