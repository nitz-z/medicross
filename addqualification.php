...
if(isset($_POST['qualification']))
{
  ...
  if(mysqli_query($conn,$sql) ){
  	            $msg="Successfully added qualification:".$qualification;
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Qualification Form</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-xl-12">
                                               <div class="col-md-12 text-center">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label">Enter New Qualification</label>
                                                    <div class="col-lg-9">
