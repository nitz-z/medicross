...
{
    $eid=$_GET['eid'];
 $sql = "SELECT * FROM client where id IN (select cid from jobcard where eid='$eid') order by id desc";
$i=0;
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="page-title">All Clients Of <?php echo $name; ?> </h3>
                            <ul class="breadcrumb">
									...
									<?php
                                        ...
                                        <tr>
                                           ...
                                           <td>'.$regid[$j].'</td>
											...
											<td>'.$phno[$j].'</td>
											<td>'.$religion[$j].'</td>
											<td><a class="btn btn-success" href="emphisjob.php?cid='.$id[$j].'&eid='.$eid.'">Go</a></td>
